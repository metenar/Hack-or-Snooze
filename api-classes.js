...
class StoryList {
  ...
  // delete user own stiries method
...
class User {
  ...
  //edit User profile only the name
  static async editProfile(currentUser,newUser){
    const response=await axios.patch(`${BASE_URL}/users/${currentUser.username}`,{
      "token":currentUser.loginToken,
      "user":{
        "name":newUser.username,
        "pasword":newUser.password,
  ...
  //adding user favorites when clicked the star
